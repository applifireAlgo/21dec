...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/ZQPQWXV5D3UBRQGUKYXHG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/data
AST_DATA_PATH=/tmp/applifire/db/ZQPQWXV5D3UBRQGUKYXHG/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/data
DB_NAME=applifire
USER=root
PASSWORD=root
PORT=3306
HOST=localhost
MYSQL=/usr/bin
PROJECT_ID=ZQPQWXV5D3UBRQGUKYXHG
