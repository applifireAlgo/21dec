...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("3YHl4vmrjY3baNF83lEhznUMsMEaaxOS");
            country.setCapitalLatitude(2);
            country.setCapitalLongitude(5);
            country.setCountryCode1("sYu");
            country.setCountryCode2("ZQk");
            country.setCountryFlag("aMFll12GCMnFjgRME1iQ5RJtgBttfOyZgY5wkD61aG0dTsUDrx");
            country.setCountryName("LWLdl73QkCQoxwK3cCyryqvFZDiTHihCIYZOv3lzm5iL0qGYL8");
            country.setCurrencyCode("cTB");
            country.setCurrencyName("6rovJCrEj95xVkVbNgt0b27r6lWcP1aKG2MR10ABM6yOgiUTde");
            country.setCurrencySymbol("PlN9y60ttWSKgFL22XHrJDqIZ4QqhYDj");
            country.setIsoNumeric(9);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("olci6N0vOhlyB6Xx4jWsqe0xeWw04xslVmu8YyYFTqm6Trv5TJ");
            currency.setUnicodeDecimal("BhzUp15vO3vShm5pwGoXEDqcwbwvgSgmO5s2pqPZyvy7x0Hvzr");
            currency.setUnicodeHex("0cdfzdKGrBU0uHe7xDMSmGVPTloODDFk3k3Bua1GSr9zcZdW9l");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("i9Pb8Q1mKugtvOs7Z22ZN8mBWwCzAmh8QuFA2f6C9P9RQc3jtA");
            currency.setUnicodeDecimal("JcDlgYkr918PTcuqPecC8eh3GewejVtWQFK7joopXpWk4qeney");
            currency.setUnicodeHex("kHkTkbAhItGUgWMIOj8l31OPdMLXjgY2GtFLepnSJhb8QwqrK5");
