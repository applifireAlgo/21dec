package dec22.app.server.service.aspect;
...
public class ServiceAspect {
    ...
    @Pointcut("execution(* dec22.app.server.service..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* dec22.app.server.service..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* dec22.app.server.service..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* dec22.app.server.service..*..*(..)) && !within(com.spartan.shield.sessionService.SessionDataMgtService+)")
    protected void allOperation() {
    }

    @Pointcut("execution(* dec22.app.server.service..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* dec22.app.server.service..get*(..))")
