...
import dec22.app.shared.authentication.SessionData;
...
public class SessionDataRepositoryImpl extends SearchInterfaceImpl implements SessionDataRepository<SessionData> {
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.authentication.SessionData s = emanager.find(dec22.app.shared.authentication.SessionData.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
