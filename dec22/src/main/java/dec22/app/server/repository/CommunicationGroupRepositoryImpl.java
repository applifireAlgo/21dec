...
public class CommunicationGroupRepositoryImpl extends SearchInterfaceImpl implements CommunicationGroupRepository<CommunicationGroup> {
    ...
    public List<CommunicationGroup> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.contacts.CommunicationGroup> query = emanager.createQuery("select u from CommunicationGroup u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<CommunicationGroup> save(List<CommunicationGroup> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.contacts.CommunicationGroup obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.contacts.CommunicationGroup s = emanager.find(dec22.app.shared.contacts.CommunicationGroup.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public CommunicationGroup findById(String commGroupId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.contacts.CommunicationGroup listOfCommunicationGroup = (dec22.app.shared.contacts.CommunicationGroup) query.getSingleResult();
