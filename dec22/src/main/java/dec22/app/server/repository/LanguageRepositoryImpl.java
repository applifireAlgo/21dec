...
public class LanguageRepositoryImpl extends SearchInterfaceImpl implements LanguageRepository<Language> {
    ...
    public List<Language> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.location.Language> query = emanager.createQuery("select u from Language u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Language> save(List<Language> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.location.Language obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.location.Language s = emanager.find(dec22.app.shared.location.Language.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Language findById(String languageId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.location.Language listOfLanguage = (dec22.app.shared.location.Language) query.getSingleResult();
