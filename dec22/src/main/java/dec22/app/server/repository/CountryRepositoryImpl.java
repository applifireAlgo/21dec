...
public class CountryRepositoryImpl extends SearchInterfaceImpl implements CountryRepository<Country> {
    ...
    public List<Country> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.location.Country> query = emanager.createQuery("select u from Country u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Country> save(List<Country> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.location.Country obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.location.Country s = emanager.find(dec22.app.shared.location.Country.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Country findById(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.location.Country listOfCountry = (dec22.app.shared.location.Country) query.getSingleResult();
