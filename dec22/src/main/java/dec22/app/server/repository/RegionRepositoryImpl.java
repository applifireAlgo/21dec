...
public class RegionRepositoryImpl extends SearchInterfaceImpl implements RegionRepository<Region> {
    ...
    public List<Region> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.location.Region> query = emanager.createQuery("select u from Region u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Region> save(List<Region> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.location.Region obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.location.Region s = emanager.find(dec22.app.shared.location.Region.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<Region> findByCountryId(String countryId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.location.Region> listOfRegion = query.getResultList();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Region findById(String regionId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.location.Region listOfRegion = (dec22.app.shared.location.Region) query.getSingleResult();
            return listOfRegion;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
