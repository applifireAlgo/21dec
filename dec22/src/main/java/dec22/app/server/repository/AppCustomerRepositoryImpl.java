...
public class AppCustomerRepositoryImpl extends SearchInterfaceImpl implements AppCustomerRepository<AppCustomer> {
    ...
    public List<AppCustomer> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.customers.AppCustomer> query = emanager.createQuery("select u from AppCustomer u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppCustomer> save(List<AppCustomer> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.customers.AppCustomer obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.customers.AppCustomer s = emanager.find(dec22.app.shared.customers.AppCustomer.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<AppCustomer> findByContactId(String contactId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.customers.AppCustomer> listOfAppCustomer = query.getResultList();
    ...
    public AppCustomer findById(String appCustomerId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.customers.AppCustomer listOfAppCustomer = (dec22.app.shared.customers.AppCustomer) query.getSingleResult();
            return listOfAppCustomer;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
