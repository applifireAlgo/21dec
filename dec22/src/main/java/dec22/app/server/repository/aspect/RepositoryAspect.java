package dec22.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* dec22.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* dec22.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* dec22.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* dec22.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* dec22.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* dec22.app.server.repository..*(..))")
