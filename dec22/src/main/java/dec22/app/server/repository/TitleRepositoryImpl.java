...
public class TitleRepositoryImpl extends SearchInterfaceImpl implements TitleRepository<Title> {
    ...
    public List<Title> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.contacts.Title> query = emanager.createQuery("select u from Title u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Title> save(List<Title> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.contacts.Title obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.contacts.Title s = emanager.find(dec22.app.shared.contacts.Title.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public Title findById(String titleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.contacts.Title listOfTitle = (dec22.app.shared.contacts.Title) query.getSingleResult();
            return listOfTitle;
        } catch (javax.persistence.PersistenceException e) {
