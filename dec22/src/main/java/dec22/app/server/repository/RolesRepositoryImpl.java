...
public class RolesRepositoryImpl extends SearchInterfaceImpl implements RolesRepository<Roles> {
    ...
    public List<Roles> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.authorization.Roles> query = emanager.createQuery("select u from Roles u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<Roles> save(List<Roles> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.authorization.Roles obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.authorization.Roles s = emanager.find(dec22.app.shared.authorization.Roles.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public void deleteRoleMenuBridge(List<RoleMenuBridge> rolemenubridge) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            for (dec22.app.shared.authorization.RoleMenuBridge _rolemenubridge : rolemenubridge) {
                dec22.app.shared.authorization.RoleMenuBridge s = emanager.find(dec22.app.shared.authorization.RoleMenuBridge.class, _rolemenubridge.getRoleMenuMapId());
                emanager.remove(s);
            }
        } catch (javax.persistence.PersistenceException e) {
            throw new SpartanPersistenceException("Error in deleting entity", e);
    ...
    public Roles findById(String roleId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.authorization.Roles listOfRoles = (dec22.app.shared.authorization.Roles) query.getSingleResult();
            return listOfRoles;
        } catch (javax.persistence.PersistenceException e) {
