...
public class AppMenusRepositoryImpl extends SearchInterfaceImpl implements AppMenusRepository<AppMenus> {
    ...
    public List<AppMenus> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<dec22.app.shared.authorization.AppMenus> query = emanager.createQuery("select u from AppMenus u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<AppMenus> save(List<AppMenus> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                dec22.app.shared.authorization.AppMenus obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            dec22.app.shared.authorization.AppMenus s = emanager.find(dec22.app.shared.authorization.AppMenus.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public AppMenus findById(String menuId) throws Exception, SpartanPersistenceException {
        try {
            ...
            dec22.app.shared.authorization.AppMenus listOfAppMenus = (dec22.app.shared.authorization.AppMenus) query.getSingleResult();
