package dec22.app.shared.authentication;
...
public class User implements Serializable, CommonEntityInterface, UserInterface, Comparator<User> {
    ...
    public User addPassRecovery(PassRecovery _passRecovery) {
        if (this.passRecovery == null) {
            this.passRecovery = new java.util.ArrayList<dec22.app.shared.authentication.PassRecovery>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            dec22.app.shared.authentication.User other = (dec22.app.shared.authentication.User) obj;
            if (userId == null) {
                return false;
