package dec22.app.shared.authorization;
...
public class Roles implements Serializable, CommonEntityInterface, Comparator<Roles> {
    ...
    public Roles addRoleMenuBridge(RoleMenuBridge _roleMenuBridge) {
        if (this.roleMenuBridge == null) {
            this.roleMenuBridge = new java.util.ArrayList<dec22.app.shared.authorization.RoleMenuBridge>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            dec22.app.shared.authorization.Roles other = (dec22.app.shared.authorization.Roles) obj;
            if (roleId == null) {
                return false;
