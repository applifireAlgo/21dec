package dec22.app.shared.contacts;
...
import dec22.app.shared.EntityAudit;
import javax.persistence.Embedded;
import dec22.app.shared.SystemInfo;
...
public class CoreContacts implements Serializable, CommonEntityInterface, CoreContactsInterface, Comparator<CoreContacts> {
    ...
    public CoreContacts addAddress(Address _address) {
        if (this.address == null) {
            this.address = new java.util.ArrayList<dec22.app.shared.location.Address>();
        }
        if (_address != null) {
    ...
    public CoreContacts addCommunicationData(CommunicationData _communicationData) {
        if (this.communicationData == null) {
            this.communicationData = new java.util.ArrayList<dec22.app.shared.contacts.CommunicationData>();
        }
    ...
    public boolean equals(Object obj) {
        try {
            dec22.app.shared.contacts.CoreContacts other = (dec22.app.shared.contacts.CoreContacts) obj;
            if (contactId == null) {
                return false;
