Ext.define('Dec22.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Dec22.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Dec22.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
