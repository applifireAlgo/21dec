Ext.define('Dec22.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Dec22.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Dec22.view.console.ConsoleWindow');
