Ext.define('Dec22.view.googlemaps.map.MapPanelController', {
	...
	createInfoWindow : function(marker, currentJson) {
		...
		google.maps.event.addListener(marker, 'click', function() {
			...
			// mainInfoWindow =
			// Ext.create('Dec22.view.googlemaps.map.MarkerInfoWindowView',{title:
	...
	loadGoogleMap : function() {
		...
		// Ext.create('Dec22.view.googlemaps.map.MarkerInfoWindowView').show();
	},
	resizeMap : function() {
