Ext.define('Dec22.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Dec22.view.reportui.datachart.chart.RatingField','Dec22.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
