 ...
 * 
 */
Ext.define('Dec22.view.apphealth.AppHealthTabPanelController',{
	extend : 'Ext.app.ViewController',
	alias : 'controller.appHealthTabPanelController',
	requires : ['Dec22.view.apphealth.AppHealthConnector'],
						...
						success : function(response, opts){
							...
							if (responseJson.response.success) {
								...
								for(var i = 0; i < appHealthSchedulerData.length; i++)
								{
									...
									var connectorPanel = Ext.create("Dec22.view.apphealth.AppHealthConnector", {
