Ext.define('Dec22.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Dec22.view.usermanagement.admin.UserPasswordReset',
	            'Dec22.view.usermanagement.admin.AddUserDetails',
	            'Dec22.view.usermanagement.admin.ViewUser'],
