Ext.define('Dec22.view.art.masterform.MasterPanelController', {
	     ...
	     Ext.Ajax.request(
 	             {
 	                 ...
 	                 success : function(response,currentObject){
 	                	 ...
 	                	 debugger;
 	                	  var masterFormPanelViewModel = Ext.create('Dec22.view.art.masterform.MasterFormViewModel');
 	                	  ...
 	                	  var newFormPanelViewModel = Ext.create('Dec22.view.art.masterform.MasterFormViewModel');
