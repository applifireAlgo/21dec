Ext.define("Dec22.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Dec22.view.clouddrive.CloudDriveController',
	             'Dec22.view.clouddrive.documentview.DocumentsView',
	             'Dec22.view.clouddrive.drivedetails.DriveDetails',
	             //'Dec22.view.clouddrive.documentview.DocumentListView'
	             ],
