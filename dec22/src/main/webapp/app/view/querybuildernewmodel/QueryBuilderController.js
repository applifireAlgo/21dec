Ext.define('Dec22.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Dec22.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Dec22.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Dec22.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Dec22.view.querybuildernewmodel.querydetail.QueryDetail');
