Ext.define('Dec22.view.querybuildernewmodel.queryentities.QueryEntitiesController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-entities-tree',
	requires:['Dec22.view.querybuildernewmodel.floatingentity.FloatingEntity','Ext.tree.*'],
	entTreePanel:null,
	queryBuilder :null,
	draggedRecord:null,
	init:function(){
