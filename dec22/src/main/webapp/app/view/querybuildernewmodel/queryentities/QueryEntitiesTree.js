Ext.define('Dec22.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Dec22.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
