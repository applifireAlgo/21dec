Ext.define('Dec22.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Dec22.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Dec22.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Dec22.view.querybuildernewmodel.floatingentity.EntitySprite',
