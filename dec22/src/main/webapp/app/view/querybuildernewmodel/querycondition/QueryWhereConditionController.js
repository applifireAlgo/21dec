Ext.define('Dec22.view.querybuildernewmodel.querycondition.QueryWhereConditionController', {
	...
	beforeCellEdit : function(editor, context, eOpts){
		...
		if(context.record.isRoot()||(context.record.isFirst()&&context.colIdx ==1 && 
			...
			var whereClauseWindow = Ext.create('Dec22.view.querybuildernewmodel.querycondition.QueryWhereClauseWindow',{
