Ext.define('Dec22.view.querybuildernewmodel.querystructure.QueryStructureController', {
	...
	init:function(){
		...
		this.queryStructreStore = Ext.create('Dec22.view.querybuildernewmodel.querystructure.QueryStructureStore');
	...
	afterrender :function( tree,eOpts ){
		...
		var rootChildNodes = root.childNodes;
				...
				for (var q = 0; q < rootChildNodes.length; q++) {
					...
					var model = Ext.create('Dec22.view.querybuildernewmodel.querystructure.QueryStructureModel');
