Ext.define('Dec22.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	//alias : [ 'layout.accordion' ],
	xtype : 'solrsearchmainpanel',
	

	requires : ['Dec22.view.searchengine.search.NorthPanel', 'Dec22.view.searchengine.search.SearchResult','Dec22.view.searchengine.search.SearchEngineMainPanelController'],
