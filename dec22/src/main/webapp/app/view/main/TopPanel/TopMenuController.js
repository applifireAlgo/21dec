...
Ext.define('Dec22.view.main.TopPanel.TopMenuController', {
 					...
 					for(var  int = 0 ; int < menuChildLength ; int++)
 		    		{
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								...
 								{
 	 									debugger;
 	 									var component = Ext.create('Dec22.view.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});
