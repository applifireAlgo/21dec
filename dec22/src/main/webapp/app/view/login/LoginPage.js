Ext.define('Dec22.view.login.LoginPage', {
	extend : 'Ext.panel.Panel',
	xtype : 'login',

	controller : 'login',
	requires : [ 'Dec22.view.login.LoginPageController',
	             // 'Dec22.view.login.LoginModel',
	             'Ext.form.Panel', 'Ext.button.Button', 'Ext.form.field.Text', 'Dec22.view.main.MainPanel' ],
