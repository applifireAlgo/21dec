Ext.define('Dec22.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Dec22.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Dec22.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Dec22.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Dec22.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
