Ext.define('Dec22.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Dec22.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Dec22.view.reportbuilder.gridconfig.GridConfigView',
	           'Dec22.view.reportbuilder.properties.PropertiesPanelView',
	           'Dec22.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
