Ext.define('Dec22.view.reportbuilder.reportlist.ReportListPanelController',{
	    	...
	    	Ext.Ajax.request(
	    	{
	    		...
	    		success:function(response, currentObject,options) 
	    		{
	    			...
	    			if (responseJson.response.success == 'true') 
	    			{
			    		...
			    		debugger;
			    		var tab=Ext.create('Dec22.view.reportbuilder.reportBuilder.ReportBuilderView', //activeTab
			    		{
			    			closable:true,
			    			iconCls:'editTabIcon',
