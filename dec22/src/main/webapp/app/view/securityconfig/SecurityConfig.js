 ...
 * 
 */
Ext.define('Dec22.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Dec22.view.securityconfig.SecurityConfigController',
			'Dec22.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
