Ext.define('Dec22.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Dec22.view.scheduler.scheduler"
		var component = Ext.create(
				"Dec22.view.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Dec22.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
