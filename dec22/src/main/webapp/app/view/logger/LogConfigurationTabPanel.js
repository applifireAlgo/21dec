...
Ext
		.define(
				'Dec22.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Dec22.view.logger.tabs.details.DetailsTab',
							'Dec22.view.logger.tabs.fileconnector.FileConnectorTab',
							'Dec22.view.logger.tabs.dbconnector.DBConnectorTab',
							'Dec22.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Dec22.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Dec22.view.logger.LogConfigurationTabPanelController',
