 ...
 * 
 */
Ext.define('Dec22.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Dec22.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
