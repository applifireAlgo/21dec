...
Ext.define('Dec22.view.mobileview.main.TopPanel.TopMenuController', {
 					...
 					for(var  int = 0 ; int < menuChildLength ; int++)
 		    		{
 						...
 						menuData.push(
 						{
 							...
 							renderCentralPanel:function(currentObject,menu)
 							{
 								...
 								{
 	 									debugger;
 	 									var component = Ext.create('Dec22.view.mobileview.art.masterform.MasterPanel',{closable : true,title: menu.text, artMasterFormId:menu.config.data.refId});
