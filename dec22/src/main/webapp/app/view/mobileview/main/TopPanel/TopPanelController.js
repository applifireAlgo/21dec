Ext.define('Dec22.view.mobileview.main.TopPanel.TopPanelController', {
	...
	onSearchClick : function(button) {
		...
		//	"Dec22.view.mobileview.scheduler.scheduler"
		var component = Ext.create(
				"Dec22.view.mobileview.searchengine.search.SearchEngineMainPanel", {
					closable : true,
					title : "Search Engine",
					refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Dec22.view.mobileview.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive",
					//refId : "-1"
				});
