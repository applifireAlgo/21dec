Ext.define('Dec22.view.mobileview.main.TopPanel.TopMenu', { 
	extend: 'Ext.toolbar.Toolbar',
    xtype: 'topMenu',
    requires:['Dec22.view.mobileview.main.TopPanel.TopMenuController',/*'Dec22.view.mobileview.main.ResourceWindow'*/],
        ...
        items: [
                {		text: 'Resorces',
                		handler:function(panel,e,eOpts)
                    	{
                    		debugger;
                    		var westAccodianPanel = this.up().up().up().up().up().down('#appMenuTreePanel');
                    		var resourceWindow = Ext.create('Dec22.view.mobileview.main.ResourceWindow');
