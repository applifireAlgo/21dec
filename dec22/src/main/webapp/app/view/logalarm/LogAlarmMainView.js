 ...
 * 
 */
Ext.define('Dec22.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Dec22.view.logalarm.LogAlarmMainViewController',
			'Dec22.view.logalarm.tree.LogAlarmTreePanel',
			'Dec22.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
