 ...
 * 
 */
Ext.define('Dec22.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Dec22.view.logalarm.mainscreen.AddLogAlarmController',
			'Dec22.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Dec22.view.logalarm.mainscreen.AppAlarmPanel',
