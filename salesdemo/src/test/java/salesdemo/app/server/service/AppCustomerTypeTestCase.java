...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("CPknH2obJI1UO5bFD3QO3XxnYKX4doJrZgnyxs6EJzYXTOIS8r");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("BBPmmijmt6B4J3fP8mmoniEwiI4oa0mtJhcAsNtmzxPSPlrMRj");
            appcustomertype.setDefaults(0);
            appcustomertype.setSequenceId(2147483647);
