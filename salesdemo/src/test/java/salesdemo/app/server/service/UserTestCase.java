...
public class UserTestCase {
    ...
    public void test1Save() {
        try {
            ...
            useraccessdomain.setDomainDescription("W6fY9gKWmIfV1qwLVZ0cWZxI5uWznbKuY4uniOTBDUUA0QKcAC");
            useraccessdomain.setDomainHelp("hLvkej7WEAnDfBJ19eNaImGNFJHr1M7PejQlFblRs2jQRCfKaa");
            useraccessdomain.setDomainIcon("NOIfXVZ4d0quhaxsu7CUnKuUqiNjytbEzADUjwZpsZprQc1Kl2");
            useraccessdomain.setDomainName("HY4XRHDlN1M04c6hnDWVDjXnurvytbNPE0DUMw2cJMN2r5sb9o");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("v2bbaPAY0OJ9xEGAaXdNwnMSmnUYoGkqwKskuvVAbawdEwYo0N");
            useraccesslevel.setLevelHelp("OFt6IJcW8M6ROigm5wARLz0zKrHXuCtu8TucmsnSXLH8Zsf5hO");
            useraccesslevel.setLevelIcon("7Ix6gBldTAwjTzAB9ErDOLEdH7yWnU2zAF6SVbEENmln69mk78");
            useraccesslevel.setLevelName("fSjOkghoDGOtGKf8qHkkuVqTFQeVhdCLqCSyL2OlmW0zcDOIvH");
            ...
            user.setPasswordAlgo("mpO3h88kdcLs0ojYsJfozTbAoWvFkYZGgOgrYP9NRRSztZ2oc1");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(2119);
            user.setUserAccessCode(7);
            user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
            user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
            java.util.List<PassRecovery> listOfPassRecovery = new java.util.ArrayList<PassRecovery>();
            PassRecovery passrecovery = new PassRecovery();
            passrecovery.setAnswer("8k4q29UPFpJzDtYnr0U4VYCj5phgmfMYxWScfd5qhAK4IqA1bz");
            Question question = new Question();
            question.setLevelid(7);
            question.setQuestion("BDcBKFgyasxjj6z1lW2bs8s0JtcA1wIXQROSh3RuR0UfCH9tHu");
            question.setQuestionDetails("Sgb");
            question.setQuestionIcon("KBgNfGiJKoFkLkwfOagam2K9OJUY7J4zQli0jeHsb7oD5PKY58");
            Question QuestionTest = questionRepository.save(question);
            map.put("QuestionPrimaryKey", question._getPrimarykey());
            passrecovery.setAnswer("incFV5bURr9ILc2smiErZDeGycmRKjWqbfVBlQSHu8nVkGyw9F");
