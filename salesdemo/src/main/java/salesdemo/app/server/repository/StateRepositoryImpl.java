...
@SourceCodeAuthorClass(createdBy = "rashmi.sharma@algorhythm.co.in", updatedBy = "", versionNumber = "1", comments = "Repository for State Master table Entity", complexity = Complexity.LOW)
